  ...
  <div class="container">
    <div class="forms-container">
      <div class="signin-signup">
        ...
        <form action="<?php echo base_url('auth/login') ?>" method="post" class="sign-in-form">
          <a href="<?php echo base_url('auth/login'); ?>" style='padding-top: 70px'>
            <img width="200px" src="<?= base_url() ?>/assets/images/logo/logo.png"></a>
          <h2 class="title">
            Menu Barcode System
          </h2>
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          <h3 style="color: black;">Anda Mau Bergabung Bersama Kami ?</h3>
          <p>
